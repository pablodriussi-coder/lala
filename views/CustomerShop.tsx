    ...
    <div className="min-h-screen bg-brand-white pb-32 animate-fadeIn font-['Quicksand'] relative">
      ...
      <div className="fixed bottom-6 left-6 z-40 flex flex-col gap-3">
        {data.settings.instagramUrl && (
           <a href={data.settings.instagramUrl} target="_blank" rel="noreferrer" className="bg-white p-3 rounded-full shadow-lg hover:scale-110 transition-all border border-brand-beige text-[#E1306C]">
        ...
        {data.settings.facebookUrl && (
           <a href={data.settings.facebookUrl} target="_blank" rel="noreferrer" className="bg-white p-3 rounded-full shadow-lg hover:scale-110 transition-all border border-brand-beige text-[#1877F2]">
             <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
           </a>
        )}
        <button onClick={() => window.open(`https://wa.me/${data.settings.whatsappNumber}?text=Hola!%20Tengo%20una%20consulta%20sobre%20tus%20productos`, '_blank')} className="bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-all">
      ...
      <div className="relative w-full h-[400px] md:h-[600px] overflow-hidden bg-white flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl animate-fadeIn">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
             <Link to="/showroom" className="bg-brand-sage text-white px-10 py-4 rounded-full font-black text-xs uppercase tracking-widest shadow-xl hover:bg-brand-dark transition-all">
                ✨ Visitar Showroom & Blog
             </Link>
          </div>
